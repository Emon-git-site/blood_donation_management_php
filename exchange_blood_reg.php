            ...
            <div class="col-md-8 mx-auto">
                <div class="card ">
                    <div class="card-header text-center bg-info text-white">
                        <h2> Exchange Doner Registration</h2>
                    </div>
                    <div class="card-body">
                     ...
                     $exchange_bg_group = $_POST['exchange_bg_group'];
                     ...
                     if ($row_number > 0) {  ?>
                       ...
                       <div class="alert alert-primary alert-dismissible fade show" role="alert">
                         ...
                         <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                          ...
                          <?php } else {
                      $insert_sql = "INSERT INTO `exchange_blood_group`(`name`, `father_name`, `address`, `email`, `password`, `phone`, `blood_group`, `exchange_blood_group`) VALUES
                      ('$doner_name','$doner_father_name','$doner_address','$doner_email','$password','$doner_phone','$bg_group', '$exchange_bg_group')";    
                        ...
                        <form action="" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="from-group mb-3 col-md-6">
                                    <label for="bg_group">Exchange Blood Group:</label>
                                    <select name="exchange_bg_group" class="form-control" >
                                        <option value="">Select Blood group</option>
                                        <option value="A+">A+</option>
                                        <option value="A-">A-</option>
                                        <option value="AB+">AB+</option>
